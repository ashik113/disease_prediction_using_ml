...
# Heading
w2 = Label(root, justify=CENTER, text="Disease Predictor using Machine Learning", fg="white", bg="darkblue")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=CENTER, text="A Project by ICONIC THINKERS", fg="white", bg="blue")
